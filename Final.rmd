...
For the Covid19 vaccine for males was very effective. We can see those results of the vaccine by `r maleffic` this being the highest percentage in compared to Females, LGBTQ, and DrugUsers. We can also see similar results when compared to females by the vaccine was also very effective compared to the placebo. The female results are `r femeffic` effectiveness. Now if we compare the LGBTQ, the vaccine was not effective at all, we eventually saw better results from the placebo than we did the vaccine. The effectiveness we saw from the LQBTQ vaccinated people were `r leffic`, and this was the lowest performance from any group. We also see bad results in relation with DrugUsers, the efficiency was `r defficlo`.
